...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            alias("spring-boot-starter").to("org.springframework.boot:spring-boot-starter:2.7.1")
            alias("spring-boot-starter-test").to("org.springframework.boot:spring-boot-starter-test:2.7.1")
        }
    }
}
