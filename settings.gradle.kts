...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            alias("kotlin").to("org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.6.10")
            alias("kotlin-reflect").to("org.jetbrains.kotlin:kotlin-reflect:1.6.10")
            alias("kotlin-plugin").to("org.jetbrains.kotlin:kotlin-gradle-plugin:1.6.10")
